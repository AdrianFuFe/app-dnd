...
<div class="space-y-6">
	<section class="rounded-3xl border border-stone-200 bg-white p-6 shadow-sm">
		...
		<p class="mt-3 max-w-3xl text-base leading-7 text-stone-600">
			This MVP flow stores identity, ability scores, combat basics, and a structured inventory
			so you can start building owned characters before deeper rules automation arrives.
		</p>
	</section>
